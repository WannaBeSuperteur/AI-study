...
![image](../images/HalluLens_5.PNG)

[(출처)](https://arxiv.org/pdf/2504.17550) : Yejin Bang and Ziwei Ji et al., "HalluLens: LLM Hallucination Benchmark"

* 쿼리 난이도에 따른 모델 성능

![image](../images/HalluLens_8.PNG)
...
* 기존 논문에서 많이 인용되는 **TruthfulQA** 는 환각 현상 평가보다는 **Factuality 평가용 벤치마크** 로 보다 적합하다.
* Factuality Benchmark 가 Hallucination Benchmark 가 될 수 있는/없는 경우는 다음과 같다.

| 구분            | 설명                                                                                                        |
|---------------|-----------------------------------------------------------------------------------------------------------|
| 될 수 **있는** 경우 | SimpleQA, PopQA 등 **Extrinsic Hallucination 을 평가하는 벤치마크로 사용될 수 있는** 벤치마크의 경우 등                            |
| 될 수 **없는** 경우 | **LLM의 knowledge cut-off** 로 인해 발생하는 **Outdated Knowledge** 와 같이, **부정확한 정보이지만 LLM의 환각 현상으로 간주될 수 없는** 경우 |
