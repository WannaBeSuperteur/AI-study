...
| 구성 요소                                                                                                                        | 설명                                                                                                |
|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Convolutional block ($g_{adaconv}^l$)                                                                                        |                                                                                                   |
| [Self-Attention](../../Natural%20Language%20Processing/Basics_트랜스포머%20모델.md#3-1-encoder-self-attention) block ($g_{attn}^l$) | Convolutional Layer 가 **receptive field 기반으로 처리** 하므로 **멀리 떨어진 부분을 contextualize 하기 어렵다** 는 문제 해결 |
| Cross-Attention block ($g_{xa}^l$)                                                                                           | 개별 word embedding 처리 목적으로 사용                                                                      |
