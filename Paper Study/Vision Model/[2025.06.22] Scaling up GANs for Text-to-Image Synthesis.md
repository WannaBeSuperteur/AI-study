...
| Loss Term                                                                                      | 적용 모델      | 설명                                                                                                                                                                                                                              |
|------------------------------------------------------------------------------------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [GAN Loss & Matching-aware Loss, $V_{MS-I/O}$](#4-3-loss-term-1-gan-loss--matching-aware-loss) | Gen, Dis   | - **GAN Loss** : [원래 표준 GAN 의 Loss Function](../../Generative%20AI/Basics_GAN.md#2-gan의-구조-및-작동-원리)<br>- **Matching-aware Loss** : Discriminator 가 '조건'을 잘 반영하도록 하기 위해, **랜덤하게 생성된 condition $\hat{c}$ 를 이용** 하여 fake pair 를 생성 |
| [CLIP contrastive Loss $L_{CLIP}$](#4-4-loss-term-2-clip-contrastive-loss)                     | Gen        | **Pre-trained CLIP encoder** 를 이용한 **contrastive loss**                                                                                                                                                                         |
| [Vision-aided adversarial loss $L_{vision}$](#4-5-loss-term-3-vision-aided-adversarial-loss)   | Gen (+Dis) | **Vision-Aided GAN** 의 Discriminator (CLIP 모델 사용) 를 추가로 사용                                                                                                                                                                      |
