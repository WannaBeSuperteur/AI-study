...
* 본인의 **개인 프로젝트 결과물** 보다는 **다소 낮은 편** 이다. **(단, 실험 조건이 다를 수 있으므로 정확한 비교는 불가)**
  * [Oh-LoRA 👱‍♀️ (오로라) v2 ('25.05.02 - 05.21) 의 **StyleGAN-VectorFind-v7**](https://github.com/WannaBeSuperteur/AI_Projects/blob/main/2025_05_02_OhLoRA_v2/stylegan/stylegan_vectorfind_v7/svm_train_report/img_generation_test_result.md) 
  * [Oh-LoRA v3 ('25.05.26 - 06.05) 의 **StyleGAN-VectorFind-v8**](https://github.com/WannaBeSuperteur/AI_Projects/blob/main/2025_05_26_OhLoRA_v3/stylegan/stylegan_vectorfind_v8/image_generation_report.md)
  * [Oh-LoRA v3.1 ('25.06.07 - 06.13) 의 **StyleGAN-VectorFind-v9**](https://github.com/WannaBeSuperteur/AI_Projects/blob/main/2025_06_07_OhLoRA_v3_1/stylegan/stylegan_vectorfind_v9/image_generation_report.md)
