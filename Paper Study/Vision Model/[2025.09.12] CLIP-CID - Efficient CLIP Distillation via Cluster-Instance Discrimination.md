...
[(출처)](https://ojs.aaai.org/index.php/AAAI/article/download/35505/37660) : Kaicheng Yang and Tiancheng Gu et al., "CLIP-CID: Efficient CLIP Distillation via Cluster-Instance Discrimination", 2025
...
| 실험                       | 실험 결과                                                                                    |
|--------------------------|------------------------------------------------------------------------------------------|
| Zero-shot Classification | - **대부분의 데이터셋** 에서 **CLIP-CID 가 가장 우수**<br>- 일부 데이터셋에서 OPENCLIP (LAION-400M) 의 결과가 가장 우수 |
| Linear probe             | Zero-shot Classification 결과와 동일한 패턴                                                      |

![image](../images/CLIP-CID_12.PNG)

[(출처)](https://ojs.aaai.org/index.php/AAAI/article/download/35505/37660) : Kaicheng Yang and Tiancheng Gu et al., "CLIP-CID: Efficient CLIP Distillation via Cluster-Instance Discrimination", 2025

**2. Zero-shot Classification 실험 결과**

![image](../images/CLIP-CID_11.PNG)

[(출처)](https://ojs.aaai.org/index.php/AAAI/article/download/35505/37660) : Kaicheng Yang and Tiancheng Gu et al., "CLIP-CID: Efficient CLIP Distillation via Cluster-Instance Discrimination", 2025

**3. Linear probe 실험 결과**

* Linear probe: **backbone 모델에 Fully-Connected (= Linear) Layer 를 추가** 하고, 해당 Linear Layer 만 학습시키는 것
  * [Fine-Tuning](../../AI%20Basics/Deep%20Learning%20Basics/딥러닝_기초_Transfer_Learning.md#3-2-미세-조정-fine-tuning) 은 backbone model 까지 학습시키는 것이므로 서로 다른 개념이다. 

### 3-3. Ablation Study

**1. Base Loss 외의 다른 Loss 포함/제외에 따른 성능**

* 모든 Loss 를 포함했을 때의 성능이 가장 좋다.
* 대략적인 성능은 **포함시킨 Loss의 개수에 비례** 한다.

![image](../images/CLIP-CID_13.PNG)

[(출처)](https://ojs.aaai.org/index.php/AAAI/article/download/35505/37660) : Kaicheng Yang and Tiancheng Gu et al., "CLIP-CID: Efficient CLIP Distillation via Cluster-Instance Discrimination", 2025

**2. Cluster Center 개수에 따른 정확도**

* Cluster Center 가 **대략 100만 개 (= 1M)** 정도일 때 정확도가 가장 높다.

![image](../images/CLIP-CID_15.PNG)

[(출처)](https://ojs.aaai.org/index.php/AAAI/article/download/35505/37660) : Kaicheng Yang and Tiancheng Gu et al., "CLIP-CID: Efficient CLIP Distillation via Cluster-Instance Discrimination", 2025

**3. PCA component 시각화 결과**

* PCA = [Principal Component Analysis](../../AI%20Basics/Machine%20Learning%20Models/머신러닝_모델_PCA.md)
* 빨간색 동그라미로 표시된 부분은 **OPENCLIP 과 CLIP-CID 의 가장 구별되는 부분** 이다.

![image](../images/CLIP-CID_14.PNG)
