...
class Regression_Background_Std_Model(tf.keras.Model):
    ...
    def __init__(self, dropout_rate=0.25):
        ...
        # conv + pooling part
        # 120 -> 118 -> 116 -> 58 -> 56 -> 28 -> 26 -> 13 -> 11 -> 9
        ...
        self.conv_5 = tf.keras.layers.Conv2D(192, (3, 3), activation='relu')
    ...
    def call(self, inputs, training):
        ...
        # conv + pooling part : 120 -> 118 -> 116 -> 58 -> 56 -> 28 -> 26 -> 13 -> 11 -> 9
        ...
        dense = tf.keras.layers.Concatenate()([dense, inputs_gender]) # 512 + 2 = 514
...
def define_model():
    ...
    model = Regression_Background_Std_Model()
...
def load_training_data():
    ...
    background_std_male = read_output('regression_background_std_info_male.csv')
    background_std_female = read_output('regression_background_std_info_female.csv')
    all_background_std_values = np.concatenate((background_std_male, background_std_female), axis=0)

    train_input_img = np.array(all_images)
    train_input_gender_prob = get_gender_prob_data(male_img_names, female_img_names)
    train_output = np.array(all_background_std_values)
...
if __name__ == '__main__':
    print('added additional filters for more accurate prediction\n')

    if 'regression_background_std' in os.listdir():
        cnn_model = tf.keras.models.load_model('regression_background_std')
        ...
        # CNN 모델 저장
        cnn_model.save('regression_background_std')
