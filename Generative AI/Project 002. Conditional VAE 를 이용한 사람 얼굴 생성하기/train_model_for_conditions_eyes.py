...
# 가로로 위쪽에서 2, 3번째 줄과 세로로 위쪽에서 1, 2번째 줄의 교차점 (16등분 중 총 4개 영역) 에 해당하는 부분만 있는 이미지로 crop
def crop_images(all_images):
    ...
    y_start = ORIGINAL_IMG_SIZE * 3 // 8 - IMG_SIZE // 2
...
def load_training_data():
    ...
    all_eyes_info = np.concatenate((mouth_male, mouth_female), axis=0)
