...
| 📝 데이터셋 제작 | LLM 학습 데이터셋 제작                  | 02.20 금 (1d)           | ```LangChain-practice-002-fine-tuning``` |       | ⬜  |
| 🧪 모델 학습   | LLM 학습 (Fine-Tuning) 실시         | 02.20 금 - 02.22 일 (3d) | ```LangChain-practice-002-fine-tuning``` |       | ⬜  |
| 🔨 모델 구현   | 메모리 구현                          | 02.23 월 (1d)           | ```LangChain-practice-003-memory```      |       | ⬜  |
