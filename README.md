...
| 구분     | 링크                                                                                          | 상세                                                                                                                                                                                                              | 일정                       |
|--------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|
| 프로젝트 1 | [Project Link](https://github.com/WannaBeSuperteur/AI_Projects/tree/main/2025_04_08_OhLoRA) | 가상 인물 생성<br>- LLM 과 결합 예정                                                                                                                                                                                       | 2025.04.08 - 04.17 (10d) |
| 프로젝트 2 |                                                                                             | 의료 이미지 분류 AI - 기존 모델 개선 (예정)<br>- LLM 결합하여 Multi-Modal 로 진행 가능                                                                                                                                                  | 2025.04.18 - 04.27 (10d) |
