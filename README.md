...
* **2025.01.27 ~ 03.06 (예정) : 🛠 ML 및 Vision 분야 기초 재정립**
...
| [Deep Learning Basics](https://github.com/WannaBeSuperteur/AI-study/tree/main/AI%20Basics/Deep%20Learning%20Basics)       | 내용 정리 및 필요 내용 추가          | 2025.02.27 - 03.02 (4d) |
| [LLM Basics](https://github.com/WannaBeSuperteur/AI-study/tree/main/AI%20Basics/LLM%20Basics)                             | 필요 내용 추가                  | 2025.03.03 - 03.04 (2d) |
| [Image Processing (Vision)](https://github.com/WannaBeSuperteur/AI-study/tree/main/Image%20Processing)                    | 내용 정리 및 필요 내용 추가          | 2025.03.05 - 03.06 (2d) |

----

* **2025.03.07 ~ 2025.03.17 (예정) : 🐋 DeepSeek 모델 Deep Dive 및 미니 프로젝트**
...
| 구분                    | 상세                                                                                            | 일정                                                                        |
|-----------------------|-----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| DeepSeek 모델 Deep Dive | DeepSeek의 생성형 모델에 대해 집중 탐구                                                                    | 2025.03.07 - 03.09 (3d)                                                   |
| 미니 프로젝트               | DeepSeek의 모델을 Fine-tuning 하여 미니 서비스 개발<br>- 언어 모델 이용 서비스 1개<br>- 이미지 생성 모델 (야누스 계열) 이용 서비스 1개 | - 언어모델 : 2025.03.10 - 03.13 (4d)<br>- 이미지 생성 모델 : 2025.03.14 - 03.17 (4d) |
