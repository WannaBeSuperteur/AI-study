...
| 프로젝트 3 | [Project Link](https://github.com/WannaBeSuperteur/AI_Projects/tree/main/2025_05_22_Improve_EffiSegNet) | 의료 이미지 (위장관 용종 이미지) Segmentation<br>- **기존 모델 (EffiSegNet) 개선**                                                                                                                                                 | 2025.05.22 - 05.27 (6d)  |
| 프로젝트 4 |                                                                                                         | **Oh-LoRA v3**<br>AI 가상 인간 **Oh-LoRA 👱‍♀️ (오로라)** 생성 고도화<br>- LLM 을 이용한 사용자 대화 구현 고도화                                                                                                                          | 2025.05.28 - 06.03 (7d)  |
