...
* 단, [ROC-AUC](../Data%20Science%20Basics/데이터_사이언스_기초_Metrics.md#3-2-area-under-roc-curve-roc-auc) 등의 성능지표는 **Accuracy, F1 Score 등 보다는 미세한 변화를 반영** 하기는 한다.
...
| [overfitting](딥러닝_기초_Overfitting_Dropout.md#2-딥러닝에서의-오버피팅-overfitting) 탐지 | Loss 에 비해 다소 늦을 수 있음                                   | Loss 가 감소에서 미세한 증가 추이로 변하는 것은 overfitting이 시작되었다는 의미임 |
