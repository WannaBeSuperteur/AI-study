...
| 구조    | Shared Backbone | Shared Head | 정확도 판정 방식                       |
|-------|-----------------|-------------|---------------------------------|
| (1)   | X               | O           | Head 의 3가지 Class 의 단순 예측 정확도    |
| (2)   | O               | O           | Head 의 3가지 Class 의 단순 예측 정확도    |
| (3)   | O               | X           | 각 Head 의 2가지 Class 의 예측 정확도의 평균 |
| (4)-1 | X               | X           | 각 Head 의 2가지 Class 의 예측 정확도의 평균 |
| (4)-2 | X               | X           | 각 Head 의 2가지 Class 의 예측 정확도의 평균 |
