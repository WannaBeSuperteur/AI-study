...
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| 최종 테스트셋 정확도          | 96.40%                                                                                                                                                           | 75.53%                                                                                                                                                   |
| HPO Valid set 최고 정확도 | 96.40%                                                                                                                                                           | 76.04%                                                                                                                                                   |
| Best Hyper-param     | ```padding_mode_conv1```: ```replicate```<br>```padding_mode_conv2```: ```zeros```<br>```padding_mode_conv4```: ```replicate```<br>```learning_rate```: 0.001229 | ```padding_mode_conv1```: ```replicate```<br>```padding_mode_2```: ```reflect```<br>```padding_mode_4```: ```reflect```<br>```learning_rate```: 0.000140 |
