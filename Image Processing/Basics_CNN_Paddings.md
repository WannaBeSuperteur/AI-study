...
| **CIFAR-10** 데이터셋<br>- train 50K / test 10K<br>- 빠른 실험 진행을 위해, 그 중 일부만 사용        | Classification<br>(10 Classes) | 4방향 경계가 **일정하지 않고 서로 다름**<br>- circular padding 으로 하면 불연속의 느낌이 있음           | ![image](images/SAMPLE_1.png) |
